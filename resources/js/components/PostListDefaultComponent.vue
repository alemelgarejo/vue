<template>
    <div>
        <div class="card mt-3" v-for='post in posts' v-bind:key="post.title">
            <img v-if="post.image" v-bind:src=" 'images/' + post.image" class="card-img-top"  alt="Card image cap">
            <img v-else v-bind:src="'images/youtube.png'" style="width:50% !important;" class="card-img-top mt-1 mx-auto d-block"  alt="Card image cap">
            <div class="card-body">
